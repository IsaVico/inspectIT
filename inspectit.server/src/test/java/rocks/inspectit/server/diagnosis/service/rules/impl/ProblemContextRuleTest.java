...
public class ProblemContextRuleTest extends TestBase {
	...
	public static class Action extends ProblemContextRuleTest {
		...
		public void problemContextMustBeTheSameInvocationIfItIsTheOnlyOneAndIsTheInvoker() {
			...
			assertThat("The returned problemContext must be the invoker", problemContext, is(parentSequence));
		}
		...
		public void problemContextMustBeTheProperInvocationIfThereOneAndIsTheInvokerWithAParentSequence() {
			...
			assertThat("The returned problemContext must be the invoker", problemContext, is(childSequence.getParentSequence()));
		}
		...
		public void problemContextMustBeTheMostSignificantClusterContext() {
			...
			assertThat("The returned problemContext must be the most significant cluster context", problemContext, is(significantContext));
		}
		...
		public void problemContextMustBeGlobalContext() {
			...
			assertThat("The returned problemContext must be the most significant cluster context", problemContext, is(globalContext));
		}
